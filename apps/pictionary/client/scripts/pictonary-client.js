$(document).ready(function() {
	var socket = io.connect('http://pictionary.davefrassoni.com:8089/');
	...
	var readytodraw =  document.getElementById('readytodraw');
	var myWord;
	
	readytodraw.onclick = function()
	{
	...
	socket.on('drawingTime', function(msg)
	{
		chatcontent.append('<p><span style="color:' + msg.color + '">' + msg.nick + '</span> is drawing!</p>');
		chatScrollDown();
	});
});